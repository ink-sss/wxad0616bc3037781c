export function scene_decode(scene) {
...
export function format_content(value = '') {
  return String(value)
...
export function getSceneData(options = {}) {
  return options.scene ? scene_decode(options.scene) : options;
}

export function isVail(value) {
...
export function isTelAvailable(value) {
  return (

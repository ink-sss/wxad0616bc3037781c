<template>
  <view class="migration-component uni-icon-uni-icon">
    <!-- TODO:migration: Recovered from compiled uni-icon/uni-icon.wxml/js; original template semantics need validation. -->
    <slot />

<template><view class="diy-block diy-notice" :style="boxStyle"><text class="diy-text">{{ params.text || (dataList[0] && (dataList[0].text || dataList[0].title)) }}</text></view></template>
<script>
export default {
  name: 'DiyNotice',

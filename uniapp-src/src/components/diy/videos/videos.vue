<template><view class="diy-block" :style="boxStyle"><video v-if="dataList[0]" :src="dataList[0].videoUrl || dataList[0].url" :poster="dataList[0].imgUrl" controls /></view></template>
<script>
export default {
  name: 'DiyVideos',

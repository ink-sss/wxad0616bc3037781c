<template>
  <view class="migration-component countdown-countdown-seckill">
    <!-- TODO:migration: Recovered from compiled countdown/countdown-seckill.wxml/js; original template semantics need validation. -->
    <slot />
...
<script>
export default {
  name: 'CountdownCountdownSeckill',

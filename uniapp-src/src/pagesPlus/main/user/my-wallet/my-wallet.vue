  ...
  <view class="wallet-page" :data-theme="theme && theme()">
    <view class="hero">
      ...
      <view v-if="cash_open" class="cash-actions">
        <button @tap="gotoPage('/pagesPlus/main/user/cash/apply')">提现</button>
        <button @tap="gotoPage('/pagesPlus/main/user/cash/list')">提现记录</button>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    gotoList(type) {
      this.gotoPage('/pagesPlus/main/user/my-wallet/my-balance?type=' + type)
    },
    gotoPay() {

...
export function createComplaint(data = {}) {
  return h5Post('/h5/complaint/create', withComplaintAliases(data))
}

export function getComplaintList(params = {}) {
  return h5Get('/h5/complaint/list', withComplaintAliases({
    page: params.page || 1,
...
export function getComplaintDetail(complaintId) {
  return h5Get('/h5/complaint/detail', withComplaintAliases({ complaintId: Number(complaintId || 0) }))
}

...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.t($options.params.text || $options.dataList[0] && ($options.dataList[0].text || $options.dataList[0].title)),
    b: common_vendor.s($options.boxStyle)
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-61579398"]]);

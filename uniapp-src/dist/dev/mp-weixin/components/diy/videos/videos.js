...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: $options.dataList[0]
  }, $options.dataList[0] ? {
    b: $options.dataList[0].videoUrl || $options.dataList[0].url,
    c: $options.dataList[0].imgUrl
  } : {}, {
    d: common_vendor.s($options.boxStyle)
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-646fc914"]]);

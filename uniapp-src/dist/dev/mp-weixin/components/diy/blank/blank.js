...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $options.toRpx($options.styleConfig.height || 20),
    b: $options.styleConfig.background || "transparent"
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-dceaaee6"]]);

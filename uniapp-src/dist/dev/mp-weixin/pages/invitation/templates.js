...
const templates = [
  ...
  },
  {
    ...
    slots: {
      ...
      time: { x: 0.212, y: 0.7, fontPct: 0.016, color: "#1D1D1C" }
    }
  },
  {
    id: "tpl604",
    ...
    slots: {
      ...
      liveName: { cx: 0.5, cy: 0.66, fontPct: 0.03, color: "#FFFFFF", bold: true, maxLen: 10 },
      time: { cx: 0.5, cy: 0.74, fontPct: 0.0195, color: "#FFFFFF" }
    }
  },
  {
    id: "tpl605",
    ...
    slots: {
      ...
      inviterName: { x: 0.287, y: 0.29, fontPct: 0.0225, color: "#122D6C", maxLen: 10 },

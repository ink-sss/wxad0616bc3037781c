...
function buildSetterActions(ctx) {
  return {
    ...
    setLandscapeMiniActive(value) {
      var _a;
      (_a = ctx.setLandscapeMiniActive) == null ? void 0 : _a.call(ctx, value);
    }
  };
}
function buildVideoActions(ctx) {
  return {
    ...
    toggleMute() {
      ...
      if (muted) {
        (_a = ctx.clearStoredSoundIntentRestore) == null ? void 0 : _a.call(ctx);
      }
      (_b = ctx.setIOSWechatBridgeSoundAutoPlayAllowed) == null ? void 0 : _b.call(ctx, !muted);
      (_c = ctx.syncLiveMiniWindowState) == null ? void 0 : _c.call(ctx, {
        force: true,
        muted,
...
function useLiveStageBinding(ctx) {
  return {
    stageState: buildStageState(ctx),
    stageActions: buildStageActions(ctx)
  };
}
exports.useLiveStageBinding = useLiveStageBinding;
